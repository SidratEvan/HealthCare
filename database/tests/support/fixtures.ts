 ...
 *
 * They exist now. The graph is built in `database/seeds/graph.ts`, out of the same
 * declared demo set (`database/seeds/data`) and the same insert helpers that
